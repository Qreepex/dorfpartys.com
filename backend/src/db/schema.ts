...
export const slugTypeEnum = pgEnum('slug_type', ['bundesland', 'kreis', 'party_art', 'monat']);
...
export const eventPhoto = pgTable(
	...
	(t) => [uniqueIndex('event_photo_event_position_idx').on(t.eventId, t.position)]
);
...
export const eventLink = pgTable(
	...
	(t) => [uniqueIndex('event_link_event_position_idx').on(t.eventId, t.position)]
);
...
export const eventRelations = relations(event, ({ one, many }) => ({
	...
	bundesland: one(bundesland, { fields: [event.bundeslandId], references: [bundesland.id] }),
	kreis: one(kreis, { fields: [event.kreisId], references: [kreis.id] }),
	partyArt: one(partyArt, { fields: [event.partyArtId], references: [partyArt.id] }),
