import { buildFilterUrl, type Country, type ResolveOutcome } from '@dorfpartys/shared';
...
export async function resolve(
	...
	const filterIds = {
		bundeslandId: classified.bundeslandIdExplicit ?? classified.bundeslandIdImplied,
	...
	const results = total > 0 ? await repo.listApprovedEvents(country, filterIds) : [];
