...
<main class="mx-auto max-w-[90ch]">
	...
	<p class="leading-relaxed">
		...
		future data processing. Moreover, you have the right to demand that the processing of your data
		be restricted under certain circumstances. Furthermore, you have the right to log a complaint
	...
	<p class="leading-relaxed">
		...
		referred to as: IONOS). Whenever you visit our website, IONOS records various logfiles along
		with your IP addresses. For details, please consult the data privacy policy of IONOS:
		<a
	...
	<p class="leading-relaxed">
		...
		presenting a website that is as dependable as possible. If appropriate consent has been
	...
	<p class="leading-relaxed">
		...
		browser and our website and to work as a filter between our servers and potentially malicious
		data traffic from the Internet. In this context, Cloudflare may also use cookies or other
		technologies deployed to recognize Internet users, which shall, however, only be used for the
	...
	<p class="leading-relaxed">
		For more information on Cloudflare’s security precautions and data privacy policies, please
		follow this link:
		<a
			class="decoration-electric-400/60 hover:decoration-electric-400 underline"
			href="https://www.cloudflare.com/privacypolicy/"
	...
	<p class="leading-relaxed">
		...
		will be deleted, unless we have other legally permissible reasons for storing your personal data
		(e.g., tax or commercial law retention periods); in the latter case, the deletion will take
	...
	<p class="leading-relaxed">
		...
		fingerprinting), the data processing is additionally based on § 25 (1) TTDSG. The consent can be
		revoked at any time. If your data is required for the fulfillment of a contract or for the
	...
	<p class="leading-relaxed uppercase">
		...
		DETERMINE THE LEGAL BASIS, ON WHICH ANY PROCESSING OF DATA IS BASED, PLEASE CONSULT THIS DATA
		PROTECTION DECLARATION. IF YOU LOG AN OBJECTION, WE WILL NO LONGER PROCESS YOUR AFFECTED
		PERSONAL DATA, UNLESS WE ARE IN A POSITION TO PRESENT COMPELLING PROTECTION WORTHY GROUNDS FOR
		THE PROCESSING OF YOUR DATA, THAT OUTWEIGH YOUR INTERESTS, RIGHTS AND FREEDOMS OR IF THE PURPOSE
	...
	<p class="leading-relaxed">
		...
		demand information about your archived personal data, their source and recipients as well as the
		purpose of the processing of your data. You may also have a right to have your data rectified or
		eradicated. If you have questions about this subject matter or any other questions about
	...
	<ul class="list-disc space-y-3 pl-6 leading-relaxed">
		...
		<li>
			...
			or for important public interest reasons cited by the European Union or a member state of the
			EU.
		</li>
	</ul>
	...
	<p class="leading-relaxed">
		...
		a TLS encryption program. You can recognize an encrypted connection by checking whether the
	...
	<p class="leading-relaxed">
		...
		website functions would not work in the absence of the cookies (e.g., the shopping cart function
		or the display of videos). The purpose of other cookies may be the analysis of user patterns or
	...
	<p class="leading-relaxed">
		...
		the provision of certain functions you want to use (e.g., for the shopping cart function) or
		...
		and similar recognition technologies has been requested, processing occurs exclusively on the
		basis of the consent obtained (Art. 6(1)(a) GDPR and § 25 (1) TTDSG); this consent may be
		revoked at any time.
	</p>
	<p class="leading-relaxed">
	...
	<p class="leading-relaxed">
		...
		we will separately notify you in conjunction with this Data Protection Policy and, if
	...
	<p class="leading-relaxed">
		...
		carried out exclusively on the basis of the consent; this consent may be revoked at any time
		with effect for the future.
	</p>
	<p class="leading-relaxed">
		The communication content exchanged between and on WhatsApp remains with us until you request us
		to delete it, revoke your consent to storage or the purpose for which the data is stored ceases
		to apply (e.g. after your request has been processed). Mandatory legal provisions, in particular
	...
	<p class="leading-relaxed">
		...
		circumstances, your personal data may also be recorded if you are not logged in or do not have
		an account with the respective social media portal. In this case, this data is collected, for
	...
	<p class="leading-relaxed">
		...
		profiles in which their preferences and interests are stored. This way you can see
		interest-based advertising inside and outside of your social media presence. If you have an
		account with the social network, interest-based advertising can be displayed on any device you
	...
	<p class="leading-relaxed">
		...
		operators of the social media portals. Details can be found in the terms of use and privacy
		policy of the respective social media portals.
	</p>

	<h3>Legal basis</h3>
	<p class="leading-relaxed">
		Our social media appearances should ensure the widest possible presence on the Internet. This is
		a legitimate interest within the meaning of Art. 6 (1) lit. f GDPR. The analysis processes
	...
	<p class="leading-relaxed">
		...
		purpose for the data storage lapses. Stored cookies remain on your device until you delete them.
	...
	<p class="leading-relaxed">
		...
		personal data at any time and free of charge. You also have the right to object, the right to
		data portability and the right to file a complaint with the responsible regulatory agency.
	...
	<h4>Instagram</h4>
	<p class="leading-relaxed">
		We have a profile on Instagram. The provider of this service is Meta Platforms Ireland Limited,
