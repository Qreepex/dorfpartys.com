<script lang="ts">
	...
	const canonical = `${SITE_URL}/datenschutz`;
</script>

<svelte:head>
	<title>Datenschutz | dorfpartys.com</title>
	<meta name="description" content="Datenschutzerklärung für dorfpartys.com." />
...
<p class="leading-relaxed">
	...
	restricted under certain circumstances. Furthermore, you have the right to log a complaint with
...
<h3>IONOS</h3>
<p class="leading-relaxed">
	The provider is the IONOS SE, Elgendorfer Str. 57, 56410 Montabaur, Germany (hereinafter referred
	to as: IONOS). Whenever you visit our website, IONOS records various logfiles along with your IP
	addresses. For details, please consult the data privacy policy of IONOS:
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
...
<p class="leading-relaxed">
	...
	presenting a website that is as dependable as possible. If appropriate consent has been obtained,
	...
	device (e.g., device fingerprinting) within the meaning of the TTDSG. This consent can be revoked
	at any time.
</p>
...
<p class="leading-relaxed">
	Cloudflare offers a content delivery network with DNS that is available worldwide. As a result,
	the information transfer that occurs between your browser and our website is technically routed
	via Cloudflare’s network. This enables Cloudflare to analyze data transactions between your
	browser and our website and to work as a filter between our servers and potentially malicious data
	traffic from the Internet. In this context, Cloudflare may also use cookies or other technologies
	deployed to recognize Internet users, which shall, however, only be used for the herein described
	purpose.
</p>
<p class="leading-relaxed">
	The use of Cloudflare is based on our legitimate interest in a provision of our website offerings
	that is as error free and secure as possible (Art. 6(1)(f) GDPR).
</p>
<p class="leading-relaxed">
...
<p>
	We use Hetzner on the basis of Art. 6(1)(f) GDPR. We have a legitimate interest in the most
	reliable depiction of our service possible. If appropriate consent has been obtained, the
	processing is carried out exclusively on the basis of Art. 6(1)(a) GDPR and &sect; 25 (1) TDDDG,
	insofar the consent includes the storage of cookies or the access to information in the
	user&rsquo;s end device (e.g., device fingerprinting) within the meaning of the TDDDG. This
...
<p class="leading-relaxed">
	...
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
		href="tel:+4915164877269">+49 1516 4877269</a
	><br />
	E-mail:
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
		href="mailto:info@dorfpartys.com">info@dorfpartys.com</a
	>
</p>
<p class="leading-relaxed">
...
<p class="leading-relaxed">
	...
	be deleted, unless we have other legally permissible reasons for storing your personal data (e.g.,
	tax or commercial law retention periods); in the latter case, the deletion will take place after
...
<p class="leading-relaxed">
	...
	6(1)(a) GDPR or Art. 9 (2)(a) GDPR, if special categories of data are processed according to Art.
	9 (1) DSGVO. In the case of explicit consent to the transfer of personal data to third countries,
	the data processing is also based on Art. 49 (1)(a) GDPR. If you have consented to the storage of
	...
	If your data is required for the fulfillment of a contract or for the implementation of
	pre-contractual measures, we process your data on the basis of Art. 6(1)(b) GDPR. Furthermore, if
	your data is required for the fulfillment of a legal obligation, we process it on the basis of
	Art. 6(1)(c) GDPR. Furthermore, the data processing may be carried out on the basis of our
	legitimate interest according to Art. 6(1)(f) GDPR. Information on the relevant legal basis in
...
<p class="leading-relaxed">
	...
	out that in these countries, a data protection level that is comparable to that in the EU cannot
	be guaranteed. For instance, U.S. enterprises are under a mandate to release personal data to the
	security agencies and you as the data subject do not have any litigation options to defend
	yourself in court. Hence, it cannot be ruled out that U.S. agencies (e.g., the Secret Service) may
	process, analyze, and permanently archive your personal data for surveillance purposes. We have no
...
<p class="leading-relaxed uppercase">
	...
	UNLESS WE ARE IN A POSITION TO PRESENT COMPELLING PROTECTION WORTHY GROUNDS FOR THE PROCESSING OF
	YOUR DATA, THAT OUTWEIGH YOUR INTERESTS, RIGHTS AND FREEDOMS OR IF THE PURPOSE OF THE PROCESSING
	IS THE CLAIMING, EXERCISING OR DEFENCE OF LEGAL ENTITLEMENTS (OBJECTION PURSUANT TO ART. 21(1)
	GDPR).
</p>
<p class="leading-relaxed uppercase">
...
<p class="leading-relaxed">
	...
	place of work or at the place where the alleged violation occurred. The right to log a complaint
	is in effect regardless of any other administrative or court proceedings available as legal
	recourses.
</p>
...
<p class="leading-relaxed">
	...
	cookies). Session cookies are automatically deleted once you terminate your visit. Permanent
	cookies remain archived on your device until you actively delete them, or they are automatically
...
<p class="leading-relaxed">
	Cookies, which are required for the performance of electronic communication transactions, or for
	the provision of certain functions you want to use (e.g., for the shopping cart function) or those
	that are necessary for the optimization (required cookies) of the website (e.g., cookies that
	provide measurable insights into the web audience), shall be stored on the basis of Art. 6(1)(f)
	GDPR, unless a different legal basis is cited. The operator of the website has a legitimate
	interest in the storage of required cookies to ensure the technically error free and optimized
	provision of the operator’s services. If your consent to the storage of the cookies and similar
	recognition technologies has been requested, processing occurs exclusively on the basis of the
...
<p class="leading-relaxed">
	...
	for the automatic eradication of cookies when the browser closes. If cookies are deactivated, the
...
<p class="leading-relaxed">This data is not merged with other data sources.</p>
<p class="leading-relaxed">
...
<p class="leading-relaxed">
	For communication with our customers and other third parties, one of the services we use is the
	instant messaging service WhatsApp. The provider is WhatsApp Ireland Limited, 4 Grand Canal
...
<p class="leading-relaxed">
	...
	parties from gaining access to the communication content. However, WhatsApp does gain access to
	metadata created during the communication process (for example, sender, recipient, and time). We
	would also like to point out that WhatsApp has stated that it shares personal data of its users
	with its U.S.-based parent company Meta. Further details on data processing can be found in the
	WhatsApp privacy policy at:
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
		href="https://www.whatsapp.com/legal/#privacy-policy"
		target="_blank"
		rel="noopener noreferrer">https://www.whatsapp.com/legal/#privacy-policy</a
	>.
</p>
<p class="leading-relaxed">
	The use of WhatsApp is based on our legitimate interest in communicating as quickly and
	effectively as possible with customers, interested parties and other business and contractual
	partners (Art. 6(1)(f) GDPR). If a corresponding consent has been requested, data processing is
	carried out exclusively on the basis of the consent; this consent may be revoked at any time with
	effect for the future.
</p>
<p class="leading-relaxed">
	The communication content exchanged between and on WhatsApp remains with us until you request us
	to delete it, revoke your consent to storage or the purpose for which the data is stored ceases to
	apply (e.g. after your request has been processed). Mandatory legal provisions, in particular
	retention periods, remain unaffected.
</p>
<p class="leading-relaxed">We use WhatsApp in the “WhatsApp Business” variant.</p>
<p class="leading-relaxed">
	Data transmission to the US is based on the Standard Contractual Clauses (SCC) of the European
	Commission. Details can be found here:
	<a
...
<p class="leading-relaxed">
	We have set up our WhatsApp accounts in such a way that there is no automatic synchronization of
	data with the address book on the smartphones in use.
</p>

<h3>Our social media appearances</h3>
<p class="leading-relaxed">This privacy policy applies to the following social media presence</p>
<ul class="list-disc space-y-2 pl-6 leading-relaxed">
	<li>
		<a
			class="decoration-electric-400/60 hover:decoration-electric-400 underline"
			href="https://instagram.com/dorfpartys"
			target="_blank"
			rel="noopener noreferrer">https://instagram.com/dorfpartys</a
		>
	</li>
	<li>
		<a
			class="decoration-electric-400/60 hover:decoration-electric-400 underline"
			href="https://tiktok.com/@dorfpartys"
			target="_blank"
			rel="noopener noreferrer">https://tiktok.com/@dorfpartys</a
		>
	</li>
</ul>

<h3>Data processing through social networks</h3>
<p class="leading-relaxed">
	We maintain publicly available profiles in social networks. The individual social networks we use
	can be found below.
</p>
<p class="leading-relaxed">
	Social networks such as Facebook, Twitter etc. can generally analyze your user behavior
...
<p class="leading-relaxed">
	...
	the social media portal can assign this visit to your user account. Under certain circumstances,
	your personal data may also be recorded if you are not logged in or do not have an account with
	the respective social media portal. In this case, this data is collected, for example, via cookies
...
<p class="leading-relaxed">
	...
	profiles in which their preferences and interests are stored. This way you can see interest-based
	advertising inside and outside of your social media presence. If you have an account with the
	social network, interest-based advertising can be displayed on any device you are logged in to or
	have logged in to.
</p>
<p class="leading-relaxed">
	...
	operators of the social media portals. Details can be found in the terms of use and privacy policy
...
<p class="leading-relaxed">
	...
	legitimate interest within the meaning of Art. 6 (1) lit. f GDPR. The analysis processes initiated
	by the social networks may be based on divergent legal bases to be specified by the operators of
	the social networks (e.g., consent within the meaning of Art. 6 (1) (a) GDPR).
</p>

<h3>Responsibility and assertion of rights</h3>
<p class="leading-relaxed">
	If you visit one of our social media sites (e.g., Facebook), we, together with the operator of the
	social media platform, are responsible for the data processing operations triggered during this
	visit. You can in principle protect your rights (information, correction, deletion, limitation of
	processing, data portability and complaint) vis-à-vis us as well as vis-à-vis the operator of the
...
<p class="leading-relaxed">
	...
	not have full influence on the data processing operations of the social media portals. Our options
	are determined by the company policy of the respective provider.
</p>

<h3>Storage time</h3>
<p class="leading-relaxed">
	The data collected directly from us via the social media presence will be deleted from our systems
	as soon as you ask us to delete it, you revoke your consent to the storage or the purpose for the
	data storage lapses. Stored cookies remain on your device until you delete them. Mandatory
...
<p class="leading-relaxed">
	...
	operators for their own purposes. For details, please contact the social network operators
...
<p class="leading-relaxed">
	...
	personal data at any time and free of charge. You also have the right to object, the right to data
	portability and the right to file a complaint with the responsible regulatory agency. Furthermore,
	you can request the correction, blocking, deletion and, under certain circumstances, the
	restriction of the processing of your personal data.
</p>

<h3>Individual social networks</h3>

<h4>Twitter</h4>
<p class="leading-relaxed">
	We use the short message service Twitter. The provider is Twitter International Company, One
	Cumberland Place, Fenian Street, Dublin 2, D02 AX07, Ireland.
</p>
<p class="leading-relaxed">
	You can customize your Twitter privacy settings in your user account. Click on the following link
	and log in:
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
		href="https://twitter.com/personalization"
		target="_blank"
		rel="noopener noreferrer">https://twitter.com/personalization</a
	>.
</p>
<p class="leading-relaxed">
	Data transmission to the US is based on the Standard Contractual Clauses (SCC) of the European
...
<p class="leading-relaxed">
	...
	<a
		...
		target="_blank"
		rel="noopener noreferrer">https://twitter.com/privacy</a
	>.
</p>

<h4>Instagram</h4>
<p class="leading-relaxed">
	We have a profile on Instagram. The provider of this service is Meta Platforms Ireland Limited, 4
...
<p class="leading-relaxed">
	...
	<a
		...
		target="_blank"
		rel="noopener noreferrer">https://www.linkedin.com/legal/l/dpa</a
	>
	and
	<a
		class="decoration-electric-400/60 hover:decoration-electric-400 underline"
		...
		target="_blank"
		rel="noopener noreferrer">https://www.linkedin.com/legal/l/eu-sccs</a
	>.
</p>
<p class="leading-relaxed">
...
<p class="leading-relaxed">
	...
	<a
		...
		target="_blank"
		rel="noopener noreferrer">https://www.tiktok.com/legal/privacy-policy?lang=en</a
	>.
</p>
<p class="leading-relaxed">
	Data transmission to third countries is based on the Standard Contractual Clauses (SCC) of the
