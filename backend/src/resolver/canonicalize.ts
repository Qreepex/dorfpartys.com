...
export function canonicalSlugsFor(classified: ClassifiedSegments): CanonicalFilterSlugs {
	return {
		bundeslandSlug: classified.bundeslandSlug ?? classified.bundeslandSlugImplied,
...
export function canonicalSegmentList(classified: ClassifiedSegments): string[] {
	...
	return [slugs.bundeslandSlug, slugs.kreisSlug, slugs.artSlug, slugs.monatSlug].filter(
